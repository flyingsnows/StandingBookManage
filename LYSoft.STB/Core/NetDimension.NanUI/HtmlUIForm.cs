...
namespace NetDimension.NanUI
{
    ...
    public class HtmlUIForm : Form, IChromiumWebBrowser
    {
        ...
        protected void InitializeChromium(string initialUrl)
        {
            ...
            RequestHandler.OnProtocolExecution += RequestHandler_OnProtocolExecution;
            ...
            GlobalObject.Add("HtmlUI", new JsHostWindowObject(this));
        ...
        {
            string url = e.Request.Url.ToString().ToLower();
            if (url.Length > 6)
            {
        ...
        private void RequestHandler_OnProtocolExecution(object sender, CfxOnProtocolExecutionEventArgs e)
        {
            e.AllowOsExecution = true;
        }
